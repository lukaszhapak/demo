package com.example.demo.spring.modules.batch.batch.config;

import com.example.demo.spring.modules.batch.batch.client.EntryResourceClient;
import com.example.demo.spring.modules.batch.batch.exception.CustomSkipPolicy;
import com.example.demo.spring.modules.batch.batch.io.EntryReader;
import com.example.demo.spring.modules.batch.batch.io.EntryWriter;
import com.example.demo.spring.modules.batch.batch.listener.EntryJobExecutionListener;
import com.example.demo.spring.modules.batch.batch.processor.EntryInitProcessor;
import com.example.demo.spring.modules.batch.batch.processor.EntryProcessor;
import com.example.demo.spring.modules.batch.batch.properties.EntryBatchJobProperties;
import com.example.demo.spring.modules.batch.batch.tasklet.EntryPreProcessingTasklet;
import com.example.demo.spring.modules.batch.core.model.Entry;
import com.example.demo.spring.modules.batch.core.repository.EntryRepository;
